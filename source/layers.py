...
from torch_geometric.nn import GCNConv,SAGPooling,global_add_pool,GATConv, GCNConv
...
class IntraGraphAttention(nn.Module):
    def __init__(self, input_dim):
        ...
        self.intra = GATConv(input_dim, 32, heads=2)
...
class InterGraphAttention(nn.Module):
    def __init__(self, input_dim):
        ...
        #self.inter = GCNConv((input_dim, input_dim), 64)
